define(['core/Base','core/Template','util/BomHelper','util/Format'],function(Base,Template,BomHelper,Format){
   ...
   Base.extend(XTemplate, Template, {
	    // private
	    re : /\{([\w\-\.\#]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?(\s?[\+\-\*\\]\s?[\d\.\+\-\*\\\(\)]+)?\}/g,
	    // private
	    codeRe : /\{\[((?:\\\]|.|\n)*?)\]\}/g,
